...
namespace Shell.NET.Util
{
    ...
    {
        /// <summary>
        /// The command output as a string. (if redirected) </summary>
        public string Output { get; private set; }

        /// <summary>
        /// The command error output as a string. (if redirected) </summary>
        public string ErrorMsg { get; private set; }

        /// <summary>
        /// The command exit code as an integer. (if redirected) </summary>
        public int ExitCode { get; private set; }

        /// <summary>
        /// An array of the command output split by newline characters. (if redirected) </summary>
